...
class Annotations2Sub(object):
    ...
    def _tab_helper(self,Text,PrimaryColour=None,BackColour=None,x=None,y=None):
        return 'Text'
    ...
    def _convert(self,string):
        for each in self.xml.find('annotations').findall('annotation'):
            ...
            #提交
            self.event.add(self,Start,End,self._tab_helper(Text,PrimaryColour,BackColour,x,y))
