...
建议使用 [yt-dlp](https://github.com/yt-dlp/yt-dlp) 来下载视频, yt-dlp 是一个多用途的视频下载器, 可以下载 Youtube 视频.
...
欢迎任何贡献, 即使只是修改了一个字符! 即使你不会编程, 也可以报告 Bug 或问我一些问题, 这个我就知道还有那些地方可以改进.[TODO][Annotations2Sub Source Code](src/README.md)
...
AnnotationsRestored [TODO]

### 衍生项目

[youtube_annotations_hack](https://github.com/USED255/youtube_annotations_hack)

https://huggingface.co/datasets/used255/youtube_annotations_text

https://archive.org/details/youtube_annotations_video_metadata
